...
local blatantV2CastDelayInput=Reg("blatantV2_castDelay",Auto:Input({Title="Cast Delay",Placeholder=tostring(CD),Value=tostring(CD),Callback=function(v)local n=tonumber(v)if n and n>=0 then CD=n end end}))
