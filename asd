...
local settings={CompleteDelay=0.001,CancelDelay=0.001}
...
safeFire(function()RF_ChargeFishingRod:InvokeServer({[1]=currentTime})end)
safeFire(function()RF_RequestMinigame:InvokeServer(1,0,currentTime)end)
...
Auto:Section({Title="Blatant V3"})

local blatantV3CompleteDelayInput=Reg("blatantV3_completeDelay",Auto:Input({Title="Complete Delay",Placeholder="0.001",Value="0.001",Callback=function(v)local n=tonumber(v)if n and n>=0 then settings.CompleteDelay=n end end}))
